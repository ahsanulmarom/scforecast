      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive">
            ...
            <form method="POST" action="<?php echo site_url('Dashboard/tampilabc') ?>"enctype="multipart/form-data">
            ...
            Tipe A: Rigorous control <br>
            Tipe B: Relaxed or Periodic Review<br>
            Tipe C: Loose Control<br>
          </div>
        </div>
      </div>
    </div>
